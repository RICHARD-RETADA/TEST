	...
	usages: "[ru/en/ko/ja/ko/de/es/fr/sh] [Text]",
	cooldowns: 5,
	dependencies: {
		"path": "",
		"fs-extra": ""
...
module.exports.run = async function({ api, event, args }) {
	try {
		...
		var languageToSay = (["ru","en","ko","ja","ko","de","es","fr","sh"].some(item => content.indexOf(item) == 0)) ? content.slice(0, content.indexOf(" ")) : 'vi';
